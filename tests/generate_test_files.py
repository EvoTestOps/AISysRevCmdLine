...
pd.DataFrame(
    {
        ...
        "abstract": [
            "This is the abstract for paper 1.",
            "",
            "This is the abstract for paper 3.",
            "This is an abstract with no title.",
        ],
    }
...
pd.DataFrame(
    {
        "abstract": [
            "This is the abstract for paper 1.",
            "This is the abstract for paper 2.",
        ]
    }
...
# empty_file.csv
pd.DataFrame(columns=["title", "abstract"]).to_csv(
    "test_csv_files/empty_file.csv", index=False
)
